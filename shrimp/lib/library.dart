...
import 'package:intl/intl.dart'; // Pastikan untuk menambahkan dependensi intl di pubspec.yaml
...
class Game {
  ...
  final double price;
  final int? discount;
  final DateTime? releaseDate; // Tambahkan field untuk tanggal rilis

  Game(this.title, this.image, this.price, {this.discount, this.releaseDate});
}

class LibraryPage extends StatelessWidget {
  // Gunakan gameList dengan tanggal rilis
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (game.releaseDate != null) const SizedBox(height: 4),
                  Text(
